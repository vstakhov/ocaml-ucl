...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9756555060a5dfd861969acf5713b790) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("easy-format", None);
                           FindlibPackage ("biniou", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "E\226c\239\188\229_O_\186\244\163V}\191\209";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
